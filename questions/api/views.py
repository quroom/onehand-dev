...
from questions.api.permissions import IsAuthorOrReadOnly, IsQuestionAuthorOrReadOnly, IsAuthenticatedOrListOnly
...
class QuestionViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticatedOrListOnly, IsAuthorOrReadOnly]
